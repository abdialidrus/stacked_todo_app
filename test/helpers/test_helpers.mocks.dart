...
import 'package:stacked_todo_app/models/todo_model.dart' as _i8;
import 'package:stacked_todo_app/services/hive_service.dart' as _i9;
import 'package:stacked_todo_app/services/todo_service.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTodoService extends _i1.Mock implements _i7.TodoService {
  @override
  List<_i8.TodoModel> getTodos() => (super.noSuchMethod(
        Invocation.method(
          #getTodos,
          [],
        ),
        returnValue: <_i8.TodoModel>[],
        returnValueForMissingStub: <_i8.TodoModel>[],
      ) as List<_i8.TodoModel>);

  @override
  List<_i8.TodoModel> createTodo(_i8.TodoModel? todo) => (super.noSuchMethod(
        Invocation.method(
          #createTodo,
          [todo],
        ),
  ...
  @override
  List<_i8.TodoModel> updateTodo(_i8.TodoModel? todo) => (super.noSuchMethod(
        Invocation.method(
          #updateTodo,
          [todo],
        ),
  ...
  @override
  List<_i8.TodoModel> deleteTodo(_i8.TodoModel? todo) => (super.noSuchMethod(
        Invocation.method(
          #deleteTodo,
          [todo],
        ),
...
class MockHiveService extends _i1.Mock implements _i9.HiveService {
  @override
  List<T> loadBoxContents<T>(_i10.Box<T>? box) => (super.noSuchMethod(
        Invocation.method(
          #loadBoxContents,
          [box],
        ),
